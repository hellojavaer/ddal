...
public class IllegalMetaDataException extends DDRDataSourceException {
    ...
    public IllegalMetaDataException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public IllegalMetaDataException(String message, Throwable cause, boolean enableSuppression,
