...
/**
 *
 * @author <a href="mailto:hellojavaer@gmail.com">Kaiming Zou</a>,created on 09/01/2017.
 */
public class SQLSyntaxErrorException extends DDRSQLParseException {
    ...
    public SQLSyntaxErrorException(String message, Throwable cause, boolean enableSuppression,
