...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
    ...
    public CallableStatementWrapper(Connection connectionWrapper, Connection connection, String sql,
                                    Object[] createStatementMethodParams, Class[] createStatementMethodParamTypes) {
        super(connectionWrapper, connection, sql, createStatementMethodParams, createStatementMethodParamTypes);
    }
