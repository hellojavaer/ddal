...
public class UninitializedDataSourceProcessor {
    ...
    private static Map<DataSourceProperty, InnerBean> map = new HashMap<DataSourceProperty, InnerBean>();

    public static void setDefaultValue(DataSourceProperty prop, Object val, boolean isSyncDefaultValue) {
        map.put(prop, new InnerBean(val, isSyncDefaultValue));
    }

    public static Object getDefaultValue(DataSourceProperty prop) {
    ...
    public static boolean isSetDefaultValue(DataSourceProperty prop) {
